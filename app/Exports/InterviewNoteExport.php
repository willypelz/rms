...
class InterviewNoteExport implements FromCollection, WithHeadings
{
	...
	private $application_ids,$company,$admin;
	 

	public function __construct($application_ids,$company,$admin)
	{
    ...
    */
    public function collection()
    {
        ...
        foreach ($this->application_ids as $key => $app_id) {
            $appl = JobApplication::whereHas("cv")->whereHas("job")->with('job', 'cv')->find($app_id);
