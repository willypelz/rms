...
class RolesSeeder extends Seeder
{
    ...
    {
        //
        $view_job = \App\Models\Permission::where('name', 'can-view-jobs')->first();
        ...
        if(count($roles) == 0) {
            ...
            $admin->attachPermissions([$view_job, $view_candidates, $view_comments, $make_comments, $take_int_notes, $view_interview]);
