                ...
                <div class="panel panel-default">
                    ...
                    <form action="" method="post"> 
                        <div class="well dash-well">
                            <h4 class="text-bolder">Create Profile</h4><br>
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input type="text" required="" class="form-control angular" id="name" name="name" placeholder="Enter name" value="">
                                </div>
                                <div class="form-group">
                                    <label for="display_name">Display Name</label>
                                    <input type="text" required="" class="form-control angular" id="display_name" name="display_name" placeholder="Enter display name" value="">
                                </div>
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <input type="text" required="" class="form-control angular" id="description" name="description" placeholder="Enter description" value="">
                                </div>
                        </div>
