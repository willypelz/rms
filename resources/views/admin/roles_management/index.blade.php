                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                    <div onclick="assignRole({!! $user->id !!})" class="btn btn-success">Assign super admin role</div @endif </td> </tr> @endforeach </tbody> </table> </div> </div> </div> </div> </div> <div class="modal widemodal fade" id="superAdminModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
