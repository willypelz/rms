        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-4 text-center text-white">
                    <h2 class=""><img src="https://cdn.insidify.com/dist/img/logos/seamlesshiring-white.svg"
                                      width="190px" alt=""></h2><br>
                        ...
                        <form role="form" class="form-signin" method="POST" action="{{ route('candidate-register') }}">
                            ...
                            <div class="row"><br>
                                ...
                                <div class="col-sm-6"><br>
                                    <p class="small text-left"><a
                                                href="{{ route('candidate-forgot', ['redirect_to' => $redirect_to]) }}">:(
                                            I can't remember my password!</a></p>
                                </div>
                                
                                <div class="col-sm-6"><br>
                                    <p class="small text-right">Registered? <a
                                                href="{{ route('candidate-login', ['redirect_to' => $redirect_to]) }}">Login</a>
                                    </p>
                                </div>
