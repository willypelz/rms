...
{{--                                        <div class="modal widemodal fade" id="deletesubsidiariesModal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">--}}
...
{{--                                                                        <p>--}}
{{--                                                                            <a aria-controls="subsidiariesModal" aria-expanded="false" class="btn btn-line btn-sm" data-toggle="collapse" data-target="#subsidiariesModal" href="">--}}
{{--                                                                                Cancel</a>--}}
