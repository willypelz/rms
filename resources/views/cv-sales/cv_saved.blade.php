    ...
    <section class="s-div dark">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class=""><br>
                        <h4 class="text-green-light text-brandon"> <i class="fa fa-folder-o"></i> Saved Candidates</h4>
                    </div>
                </div>
                <div class="col-sm-5">
                    ...
                    <div class="row">
                      ...
                      <span class="text-brandon"><i class="fa fa-folder"></i> Folders &nbsp;</span>                 
                        ...
                        <form action="" class="form-inline pull-right">
                          <input type="text" class="form-control" placeholder="Search entire saved candidates" style="width:350px">
                        </form>                      
                        </div> 
