								...
								<tr>
									<td style="font-family:Arial,Helvetica,sans-serif">
															...
															<div style="color:#2d2d2d;width:100%;float:none;clear:both;">
																...
																<div style="color:#5d5d5d;background-color: #fbfbfb;padding:5% 7% 7%;border: 1px dotted #cecece;border-radius: 4px;">
																	<div style="color:#2d2d2d;width:100%;margin:0 auto;">
																		...
																		<p style="font-family:Arial,Helvetica,sans-serif;color:#2d2d2d;font-size:15px;font-weight:400;margin:16px 0;padding:0;text-align: none;line-height:1.4em;">Dear {{ $candidate->candidate->last_name}},
																		<br><br>
																		Trust this meets you well.
																		<br><br>
																		<p> You have a new message based on your job application for the post of {{ $candidate->job->title}} </b> </p>
									                                    <br><br>
                                   
                                    									  <a href="{{ $link }}" download>View Message</a>
																		</p>
										...
										<div style="color:#777;width:94%;text-align:center;margin:7% auto 0;padding:0" align="center">
											<p style="font-family:Arial,Helvetica,sans-serif;color: #6b6b6b;font-size:12px;line-height:1.42em;text-align:center;margin:16px 0 8%;padding:0;" align="center">This notification was sent to <a href="mailto:{{ $candidate->candidate->email }}" target="_blank">{{ $candidate->candidate->email }}</a>
