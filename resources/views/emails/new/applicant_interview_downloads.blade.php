									...
									<td style="font-family:Arial,Helvetica,sans-serif">
															...
															<div style="color:#2d2d2d;width:100%;float:none;clear:both;">
																...
																<div style="color:#5d5d5d;background-color: #fbfbfb;padding:5% 7% 7%;border: 1px dotted #cecece;border-radius: 4px;">
																	<div style="color:#2d2d2d;width:100%;margin:0 auto;">
																		{{-- <h3 style="font-size: 20px;margin:0 0 5%;padding:0;"><a href="" style="font-family: Roboto,'Open Sans','Helvetica Neue',Arial,Helvetica,sans-serif;word-wrap:break-word;color: #3a5979;text-decoration:none;display:block;text-align: center;width:100%;" target="_blank">Export for  . {{ $filename }} . is ready</a></h3> --}}
																		...
																		<p style="font-family:Arial,Helvetica,sans-serif;color:#2d2d2d;font-size:15px;font-weight:400;margin:16px 0;padding:0;text-align: none;line-height:1.4em;">Dear {{$name}},
																		<br><br>
																		@if(!is_null($filename)) Export for {{ $filename }} is ready @else There are no applicants currently in your export with cvs  @endif
                                                                        <br>
																		</p>
																		@if($route)
																		<div style="color:#2d2d2d;" align="center">
																			<a href="{{ $route }}" style="font-family:Arial;word-wrap:break-word;color:#ffffff;border-radius: 3px;display:inline-block;font-size:14px;font-weight:400;line-height: 42px;text-align:center;text-decoration:none;width:200px;background-color: #4BB779;text-transform:uppercase" target="_blank"> Download</a>
																			{{-- <a  style="font-family:Arial;word-wrap:break-word;color:#ffffff;border-radius: 3px;display:inline-block;font-size:14px;font-weight:400;line-height: 42px;text-align:center;text-decoration:none;width:200px;background-color: #4BB779;text-transform:uppercase" target="_blank">Download</a> --}}
																		</div>
																		
                                                                        <p style="font-family:Arial,Helvetica,sans-serif; font-size:15px;line-height:1.3em;color:#afafaf">If clicking the link above does not work, kindly click the below .</p>
                                                                        <p style="width: 460px; word-wrap: break-word"><a href="{{ $route }}" target="_blank"> {{$route}}</a></p>
																		@endif
																		<hr style="border-width:0 0 1px">
																	...
																	<br>
																	<small style="color:#afafaf">If you did not attempt to sign up on {{ getEnvData('APP_URL', null, $client_id) }}, kindly ignore this mail.</small>
																</div>
															</div>
										...
										<div style="color:#777;width:94%;text-align:center;margin:7% auto 0;padding:0" align="center">
											{{-- <p style="font-family:Arial,Helvetica,sans-serif;color: #6b6b6b;font-size:12px;line-height:1.42em;text-align:center;margin:16px 0 8%;padding:0;" align="center">This notification was sent to <a href="mailto:{{ $user->email }}" target="_blank">{{ $user->email }}</a> --}}
												<br> because you registered on {{ getEnvData('APP_URL',null, $client_id) }}
												<br>
												...
												<br>View SeamlessHiring's <a href="https://seamlesshr.com/privacy-security/" target="_blank">Privacy Policy</a></p>
