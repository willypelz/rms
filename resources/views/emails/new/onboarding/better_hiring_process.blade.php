								...
								<tr>
									<td style="font-family:Arial,Helvetica,sans-serif">
															...
															<div style="color:#2d2d2d;width:100%;float:none;clear:both;">
																...
																<div style="color:#5d5d5d;background-color: #fbfbfb;padding:5% 7% 7%;border: 1px dotted #cecece;border-radius: 4px;">
																	<div style="color:#2d2d2d;width:100%;margin:0 auto;">
																		<h3 style="font-size: 20px;margin:0 0 5%;padding:0;"><a href="" style="font-family: Roboto,'Open Sans','Helvetica Neue',Arial,Helvetica,sans-serif;word-wrap:break-word;color: #3a5979;text-decoration:none;display:block;text-align: center;width:100%;" target="_blank">Let Us Help You Build a Better Hiring Process.</a></h3>
																		...
																		You might find Bola’s story interesting.<br>
																		Bola is responsible for hiring at CPR a phone store with core activities on sales and repair of high end smartphones.<br>
																		When Bola came on board, it was for the recruitment of only a handful of employees being the first chain of the store in Nigeria.<br>
																		She started with the trial version.<br>
																		Seeing that although her recruitment needs were few, Bola wanted to involve the rest of the management team.<br>
																		Considering their individual busy schedules, it almost seemed impossible, until she found SeamlessHiring.<br>
																		Notes/comments left were easily reviewed and feedback were shared faster without affecting other tasks. <br>
																		CPR is growing really quickly in Nigeria, which brings the need for quality employees; hiring faster and selecting better has now become priority. <br>
																		Thankfully, Bola has the right tool for this.<br>
																		How can we help you build a better hiring process?<br>
																		Kindly take a few seconds to let us know what your needs are by replying this mail.<br>
																		...
																		<hr style="border-width:0 0 1px">
																		<p style="color:#666; line-height:1.5em">Best,<br>
																		The Seamless Hiring Team.
																		</p>
																			<div style="display:block; width:100%; margin: 5px auto">
																				

																				<br>
																				<strong>PS: We respond to emails, don’t hesitate to ask for our help.</strong>
										...
										<div style="color:#777;width:94%;text-align:center;margin:7% auto 0;padding:0" align="center">
											<p style="font-family:Arial,Helvetica,sans-serif;color: #6b6b6b;font-size:12px;line-height:1.42em;text-align:center;margin:16px 0 8%;padding:0;" align="center">This notification was sent to <a href="mailto:{{ $email }}" target="_blank">{{ $email }}</a>
