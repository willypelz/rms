															...
															<div style="color:#2d2d2d;width:100%;float:none;clear:both;">
																...
																<div style="color:#5d5d5d;background-color: #fbfbfb;padding:5% 7% 7%;border: 1px dotted #cecece;border-radius: 4px;">
																	<div style="color:#2d2d2d;width:100%;margin:0 auto;">
																		<h3 style="font-size: 20px;margin:0 0 5%;padding:0;"><a href="" style="font-family: Roboto,'Open Sans','Helvetica Neue',Arial,Helvetica,sans-serif;word-wrap:break-word;color: #3a5979;text-decoration:none;display:block;text-align: center;width:100%;" target="_blank">You Signed Up because...</a></h3>
																		<hr style="border-width:0 0 1px">
																		<p style="font-family:Arial,Helvetica,sans-serif;color:#2d2d2d;font-size:15px;font-weight:400;margin:16px 0;padding:0;text-align: none;line-height:1.4em;">I really appreciate you joining our recruitment solution platform, and I know you’ll love it when you see how easy it truly is to recruit seamlessly from everywhere.
																		<br>
																		We built SeamlessHiring to help companies from startups to SMEs to even large corporations.
																		<br>I hope you don’t mind me asking: Why did you sign up for SeamlessHiring?
																		<br>Your reason(s) would be really helpful in making sure we’re delivering on all our users want. 
																		<br>Just hit “reply” and let me know.
																		<br>By the way, you’ll receive a few more emails from us to help you see all the benefits and numerous tips on how you and your team can work together without a glitch.

																		</p>
																		
																		<hr style="border-width:0 0 1px">
																		<p style="color:#666; line-height:1.5em">Thanks,
																		
																		<br></p>
																			<div style="display:block; width:100%; margin: 5px auto">
																				<img src="https://media.licdn.com/mpr/mpr/shrinknp_400_400/p/4/005/09a/009/3270bf0.jpg" alt="emmanuel" width="75px" style="border-radius:50%">
																				<br><br>
																				Emmanuel Okeleji,
																		<br>CEO,
																			<br>SeamlessHiring.com
