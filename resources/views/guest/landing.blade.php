    ...
    <div class="row">
      <div class="col-sm-8 col-sm-offset-2 text-center">
        <div class="pagehead text-white">
          ...
          <h1 class="fa-3x bold hidden-xs text-brandon text-light no-margin"><span class="text-green-light">Everything</span> You Need To Hire, In One Place!</h1>
          ...
          <br><br>
          <p><a href="register" class="btn btn-lg btn-danger">Get Started for Free &nbsp; <i class="fa fa-chevron-right"></i></a></p>
...
<div class="row">
  <div class="col-xs-2">
    <div class="btn-group btn-group-vertical btn-tabs home-tabs no-pad no-margin" role="tab-list" aria-label="...">
      
      <div class="btn-group" role="group">
        <a href="#tab-1" aria-controls="tab-1" role="tab-1" data-toggle="tab" type="button" class="btn btn-line text-capitalize">
          <span class="fa-lg">
            <span class="hidden-xs text-brandon">
              <span class="fa-stack fa-lg">
                <i class="fa fa-circle fa-stack-2x fa-inverse"></i>
                <i class="fa fa-send fa-stack-1x"></i>
              </span>
            Broadcast Jobs everywhere.</span><br></span>
        ...
        <div class="btn-group" role="group">
          <a href="#tab-2" aria-controls="tab-2" role="tab-2" data-toggle="tab" type="button" class="btn btn-line text-capitalize">
            <span class="fa-lg">
              ...
              Organize, Sort & Track Applicants</span><br></span>
              <i class="hidden-xs fa fa-arrow-right pull-right fa-abx fa-lg"></i>
          ...
          <div class="btn-group" role="group">
            <a href="#tab-3" aria-controls="tab-3" role="tab-3" data-toggle="tab" type="button" class="btn btn-line text-capitalize">
              <span class="fa-lg">
                ...
                Conduct Online Recruitment Tests</span><br></span>
                <i class="hidden-xs fa fa-arrow-right pull-right fa-abx fa-lg"></i>
            ...
            <div class="btn-group" role="group">
              <a href="#tab-4" aria-controls="tab-4" role="tab-4" data-toggle="tab" type="button" class="btn btn-line text-capitalize text-muted">
                <span class="fa-lg">
                  ...
                  Run Background & Medical Checks</span><br></span>
                  <i class="hidden-xs fa fa-arrow-right pull-right fa-abx fa-lg"></i>
              ...
              <div class="btn-group" role="group">
                <a href="#tab-5" aria-controls="tab-5" role="tab-5" data-toggle="tab" type="button" class="btn btn-line text-capitalize text-muted">
                  <span class="fa-lg">
                    ...
                    Save & Download the Entire Process</span><br></span>
            ...
            <div class="col-xs-10 ">
              ...
              <div class="tab-content no-margin" style="border-left:1px solid #ccc">
                <section id="tab-1" role="tabpanel" class="section-tab white tab-pane active">
                  <div class="container">
                    <div class="row">
                      <div class="col-xs-12">
                        <h2 class="animated fadeIn text-light no-margin text-center text-capitalize"><span class="text-orange">Seamlessly Attract</span> Talent From Everywhere.</h2>
                        .
                        <div class="clearfix"></div>
                      <hr class="hr-bg pull-">
                      <div class="clearfix"></div>
