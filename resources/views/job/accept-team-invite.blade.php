                ...
                <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-sm-12">
                    ...
                    <div class="white">
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-sm-offset-4">
                                    ...
                                    <a role="button"
                                       ...
                                       href="#loginForm"
                                       class="btn btn-primary btn-block"> Activate</a>
                                </div>
                            ...
                            <div class="row">
                                <form action=""
                                      class="collapse pad-v-sm"
                                      method="post"
                                      id="loginForm"
                                      style="background: #F1F3F5;border-bottom: 1px solid #bbb">
                                    <div class="col-sm-6 col-sm-offset-3">
                                        <div class="form-group">
                                            <label for="Email">Email</label>
                                            <div class="form-control" id="Email">{{ $team->email }}</div>
                                        </div>
                    ...
                    <div class="page page-sm foot no-bod-rad">
                        <div class="col-sm-6 col-sm-offset-3 text-center"><!-- <hr> -->
                            <p><img src="http://seamlesshiring.com/img/seamlesshiring-logo.png" alt="" width="250px">
                            </p>
