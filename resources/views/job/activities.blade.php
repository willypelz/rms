                ...
                <div class="col-sm-12">
                    <div class="page no-bod-rad">
                        ...
                        <div class="btn-group btn-group-justified btn-tabs job-dash no-pad text-brandon" role="group" aria-label="...">
                          ...
                          <div class="btn-group" role="group">
                            <a href="{{ url('jobs/activities') }}" type="button" class="btn btn-line text-capitalize in">
                ...
                <div class="col-xs-4 col-xs-push-1">
                    <div class="">
                        ...
                        <tr> 
                            ...
                            <td class="text-center"><h1 class="no-margin text-bold"><a href="cv/cv_saved">3,281</a></h1><small class="text-muted">Applicants</small></td> 
                        </tr> 
                        <!--tr> 
