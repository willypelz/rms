    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-sm-12">
          ...
          <div class="">
            <div class="row">
              <div class="col-sm-12 text-center">
                <h4 class="text-brandon l-sp-5 text-uppercase">Super Admin Accept</h4>
              </div>
        ...
        <div class="white">
            ...
            <div class="row pad-v-sm">
              <div class="col-sm-10 col-sm-offset-1">
                <p class="lh1-7 text-normal" style="font-size: 1.15em; color: #5d5d5d">
                  ...
                  <br>You have accepted the invitation as Role of Super Admin at {{$company->name}}, Create your password below <strong></strong>
                </p>
          ...
          <div class="row">
            <form action="{{route ('admin-accept-invite', ['id'=> $user->user_token, 'company_id'=> $company->id] )}}" class="collapse pad-v-sm" method="post" id="loginForm" style="background: #F1F3F5;border-bottom: 1px solid #bbb">
              <div class="col-sm-6 col-sm-offset-3">
                <div class="form-group">
                  <label for="">Email</label>
                  <input type="email" value="{{ $user->email }}" disabled="disabled" class="form-control" placeholder="Enter Email">
                </div>
