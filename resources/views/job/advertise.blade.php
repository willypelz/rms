                                            ...
                                            <img alt="" src="{{ $b['img'] }}" height="45px"> <hr>
                                                    ...
                                                    <p>
                                                      ...
                                                      <span class="purchase-action">
                                                            <a href="" class="btn btn-success btn-board-buy" data-count="1" data-cost="500"><i class="fa fa-plus"></i> Post for &#8358; {{ $b['price'] }}</a>
                                                          <button class="btn btn-line btn-board-discard collapse" data-count="1" data-cost="500"><i class="fa fa-trash"></i> Remove from Cart </button>
                                                    </span>
