                     ...
                     <div class="col-xs-12">@include('job.board.includes.applicant-status')</div>
                        ...
                        <div class="col-xs-8 ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-2">
                                    <div class="dropdown">
                                      <button class="btn btn-line btn-sm dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                        Download
                                ...
                                <div id="h_act-on" class="col-xs-12 app-action" style="display:none;">
                                    <div>
                                        <div class="btn-group select-action btn-group-justified" id="mass-action">
                                            <a class="btn btn-line status-1" data-action="SHORTLISTED" data-toggle="modal" data-target="#viewModal" id="modalButton" href="#viewModal" data-title="Shortlist?" data-view="{{ route('modal-shortlist') }}" data-app-id="" data-cv="" data-type="normal">Shortlist All</a>
                                            <a class="btn btn-line status-1" type="button" data-action="ASSESSED"  data-toggle="modal" data-target="#viewModal" id="modalButton" href="#viewModal" data-title="Test" data-view="{{ route('modal-assess') }}" data-app-id="" data-cv="" data-type="wide">Test All</a>
                                            <a class="btn btn-line status-1" type="button" data-action="INTERVIEWED"  data-toggle="modal" data-target="#viewModal" id="modalButton" href="#viewModal" data-title="Schedule an interview for" data-view="{{ route('modal-interview') }}" data-app-id="" data-cv="" data-type="normal">Interview All</a>
                                            <a class="btn btn-line status-1" type="button" data-action="HIRED"  data-toggle="modal" data-target="#viewModal" id="modalButton" href="#viewModal" data-title="Hire" data-view="{{ route('modal-hire') }}" data-app-id="" data-cv="" data-type="normal">Hire All</a>
                                            ...
                                            <a class="btn btn-line status-1" type="button" data-action="PENDING" data-toggle="modal" data-target="#viewModal" id="modalButton" href="#viewModal" data-title="Do you want to return to pending?" data-view="{{ route('modal-return-to-all') }}" data-app-id="" data-cv="" data-type="normal" style="display:none;" >Return to Pending</a>
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a data-toggle="modal" data-target="#viewModal" id="modalButton" href="#viewModal" data-title="Background Check" data-view="{{ route('modal-background-check') }}" data-app-id="" data-cv="" data-type="wide">Background Check</a></li>
                                                    <li><a data-toggle="modal" data-target="#viewModal" id="modalButton" href="#viewModal" data-title="Medical Check" data-view="{{ route('modal-medical-check') }}" data-app-id="" data-cv="" data-type="wide">Medical Check</a></li>
                                                </ul>
                                            </div>
                                        </div>
