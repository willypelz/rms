...
<div class="btn-group btn-group-justified btn-tabs job-dash no-pad text-brandon" role="group" aria-label="...">
                           ...
                           <a  @if(isset($user_role) && !is_null($user_role) ? $user_role->name == 'interviewer' : $is_super_admin)href="#" @else  href="{{ route('job-board', [$job->id]) }}" @endif type="button" class="btn btn-line text-capitalize @if($active_tab == 'activities') in @endif">
                          ...
                          <div class="btn-group" role="group">
                            <a @if(!$is_super_admin) href="#" @else href="{{ route('job-promote', [$job->id]) }}" @endif type="button" class="btn btn-line text-capitalize text-muted @if($active_tab == 'promote') in @endif">
