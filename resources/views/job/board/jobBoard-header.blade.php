                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="badge badge-job badge-job-active">
                            <small class="">
                                ...
                                <b>&nbsp; {{ ucfirst($job['is_for'])}} {{ $job['is_private'] == 1 ? '(PRIVATE)' : '(PUBLIC)'}} </b>
                            </small>
                        </div>
                    </div>
                    @php
                    ...
                    <div  class="pull-left text-white small" style="margin-top: 24px;">Recruitment<br>Stage &nbsp; &rarr;</div>
                        ...
                        <div class="btn-group btn-group-justified" role="group">
                            <div  class="btn-group" role="group">
                                <a href="{{ route('job-share',['jobID'=>$job->id,'jobSlug'=>str_slug($job->title)]) }}" target="_blank" type="button" class="btn-sm btn btn-info status"><i class="fa fa-eye"></i> &nbsp;Preview</a>
                            </div>
                            <div  class="btn-group" role="group">
