                            ...
                            <div class="col-sm-12">
                                <div class="page no-bod-rad" style="border-radius: 0 0 0 0">
                                    <div class="row">
                                        <div class=" job-cta hidden">
                                            <div class="col-sm-3">
                                                <a href="" class="btn btn-success btn-block"><i class="fa fa-edit"></i>
                                                    Apply <span class="">for Job</span></a>
                                            </div>
                                            <div class="col-sm-5">
                                                <div class="btn-group btn-group-justified">
                                                    <div class="btn-group">
                                                        <a href="" class="btn btn-line"> Save <span class="">to
                                                                mailbox</span></a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <a href="" class="btn btn-line"> Send<span class=""> to
                                                                friend</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <p>
                                                    <pre style="padding: 0;word-wrap: normal;word-break: break-word;border: 0;background: none;overflow: overlay;white-space: pre-wrap;">{{ @$company->address }}</pre>
                                                    </p>
                                                    <hr>
                                                    <!--p>
                                ...
                                <div class="page page-sm foot no-bod-rad">
                                    <div class="col-sm-6 col-sm-offset-3 text-center"><!-- <hr> -->
                                        <p><img src="{{ url('/') }}/img/seamlesshiring-logo.png" alt="" width="225px">
                                        </p>
                                        <p>
                                            <small class="text-muted">Powered by <a
                                                        href="http://www.seamlesshiring.com"> SeamlessHiring</a> &nbsp;
                                                &copy; <?php echo date('Y') ?>. SeamlessHiring
                                            </small>
                                        </p>
                                    </div>
                                    <div class="clearfix"></div>
