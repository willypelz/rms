                    ...
                    <div class="modal-body">
                        ...
                        <div id="listFieldItems" class="list-group no-margin">
                            <a href="#" class="list-group-item addFieldRadio">
                                <img src="input-radio.png" class="img-form pull-left" alt="Radio Buttons">
                                <h4 class="list-group-item-heading">Radio Buttons</h4>
                                <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
                                <span class="clearfix"></span>
                            </a>
                            <a href="#" class="list-group-item addFieldDrop">
                                <img src="input-radio.png" class="img-form pull-left" alt="Dropdown Option list">
                                <h4 class="list-group-item-heading">Dropdown Option list</h4>
                                <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
                                <span class="clearfix"></span>
                            </a>
                            <a href="#" class="list-group-item addFieldChck">
                                <img src="input-cehecbox.png" class="img-form pull-left" alt="Checkbox">
                                <h4 class="list-group-item-heading">Checkbox</h4>
                                <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
                                <span class="clearfix"></span>
                            </a> 
                            <a href="#" class="list-group-item addFieldArea">
                                <img src="input-textarea.png" class="img-form pull-left" alt="Textarea">
                                <h4 class="list-group-item-heading">Textarea</h4>
                                <p class="list-group-item-text">For adding long paragraph texts</p>
                                <span class="clearfix"></span>
                            </a> 
                            <a href="#" class="list-group-item addFieldOpt">
                                <img src="input-multi.png" class="img-form pull-left" alt="Multiple Options">
                                <h4 class="list-group-item-heading">Multiple Options</h4>
                                <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
                                <span class="clearfix"></span>
                            </a> 
                            <a href="#" class="list-group-item addFieldFile">
                                <img src="input-file.png" class="img-form pull-left" alt="File Upload field">
                            ...
                            <!-- Adding Radio Buttons -->
                                <div class="fieldInput-radio collapse">
                                    ...
                                    <div class="form-group">
                                        <label for="fieldInput-radio-name">Name / Question</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="fieldInput-radio-desc">Short Description</label>
