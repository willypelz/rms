                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <select required
                                                                                ...
                                                                                @foreach($countries as $country)
                                                                                    <option value="{{ $country }}" {{ ( @$last_cv->location == $country || (in_array(@$last_cv->location,$states) && $country == 'Nigeria')) ? 'selected="selected"' : '' }} >
                                                                                        {{ $country }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                        ...
                                                                        <div class="col-sm-6 state_section @if( (Request::old('location')) || $errors->has('location') || (in_array(@$last_cv->location,$states) || @$last_cv->location == 'Nigeria'))  @else hidden @endif"
                                                                            ...
                                                                            <select {{( $fields->location->is_required ) ? "required" : "" }}
                                                                                ...
                                                                                @foreach($states as $state)
                                                                                    <option value="{{$state != 'Nigeria' ? $state : 'Across Nigeria' }}" {{ ( str_replace('Nigeria','Across Nigeria',@$last_cv->location) == $state) ? 'selected="selected"' : '' }} >
                                                                                        {{ $state != 'Nigeria' ? $state
                                                                                        : 'Across Nigeria' }}
                                                                                    </option>
                                                                                @endforeach
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    @if( $fields->date_of_birth->is_visible )
                                                                        <div class="col-sm-4"><label for="job-loc">date
                                                                                of
                                                                    ...
                                                                    @if( $fields->years_of_experience->is_visible )
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <select class="form-control"
                                                                                ...
                                                                                @for( $i = 0; $i <= 50; $i ++ )
                                                                                    <option value="{{ $i }}"
                                                                                            @if( @$last_cv->years_of_experience == $i ) selected="selected" @endif >
                                                                                        {{ $i }}
                                                                                    </option>
                                                                                @endfor
                                                                ...
                                                                <div class="row">
                                                                    @if( isset($fields->school->is_visible) && $fields->school->is_visible )
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <span >Can't find your school? <a onclick="schoolSelect('others')"
                                                                                        >click here</a> </span>
                                                                    ...
                                                                    <div class="col-sm-6 others hidden">
                                                                        ...
                                                                        {{ Form::text('others', @$last_cv->school, array('class'=>'form-control otherSchool',( isset($fields->school->is_required) && $fields->school->is_required  ) ? "" : "" )) }}
                                                                    ...
                                                                    @if( isset($fields->course_of_study->is_visible) && $fields->course_of_study->is_visible  )
                                                                        <div class="col-sm-6">
                                                                            <label for="">
                                                                                <!-- <i class="fa fa-lock"></i>&nbsp;  -->
                                                                                Course of
                                                                                Study @if( $fields->course_of_study->is_required )
                                                                                    <span class="text-danger">*</span>@endif
                                                                            </label>
                                                                    ...
                                                                    @if( isset($fields->completed_nysc->is_visible) && $fields->completed_nysc->is_visible  )
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <select class="form-control"
                                                                                ...
                                                                                <option value="yes"
                                                                                        @if( @$last_cv->completed_nysc == 1 ) selected="selected" @endif >
                                                                                    Yes
                                                                                </option>
                                                                                <option value="no"
                                                                                        @if( @$last_cv->completed_nysc == 0 ) selected="selected" @endif >
                                                                                    No
                                                                                </option>
...
{{ Form::select('location', array('Lagos' => 'Lagos', 'Abuja' => 'Abuja'), @$last_cv->location, array('placeholder'=>'choose', 'class'=>'form-control')) }}
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    @if( isset($fields->remuneration->is_visible) && $fields->remuneration->is_visible )
                                                                        <div class="col-sm-6">
                                                                            <label for="job-title">Minimum
                                                                                Remuneration @if( $fields->remuneration->is_required )
                                                                                    <span class="text-danger">*</span>@endif
                                                                            </label>
                                                                ...
                                                                <div class="row">
                                                                    @if( $fields->specializations->is_visible )
                                                                        <div class="col-sm-6"><label for="job-title">Your
                                                                            ...
                                                                            <br><select name="specializations[]"
                                                                                        multiple=""
                                                                                        id=""
                                                                    ...
                                                                    @if( $fields->cv_file->is_visible )
                                                                        <div class="col-xs-12">
                                                                            ...
                                                                            <label for="">Attach your
                                                                                CV @if( $fields->cv_file->is_required )
                                                                                    <span
                                                                    ...
                                                                    @foreach( $custom_fields as $custom_field )
                                                                        ...
                                                                        <div class="col-sm-6 custom-field">
                                                                            ...
                                                                            @elseif( $custom_field->type == 'FILE' )
                                                                                ...
                                                                                <small>Allowed files are doc, docx and
                                                                                    pdf</small>
                                                                            @endif
                                                        ...
                                                        @else
                                                            <div>Something went wrong with this job posting, please
                                                                contact support
                                                            </div>
                                                        @endif
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            school.change(function () {
             schoolSelect(school.val());
            });
        });

        function schoolSelect(params) {
            if (params == 'others') {
