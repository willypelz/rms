                  ...
                  <div class="col-xs-8 col-xs-offset-2">
                    ...
                    <div class="row">
                          ...
                          <div class="col-xs-6 col-xs-offset-3 text-center">
                            <hr>
                            <p class="hidify">For a wider reach, you can <a data-toggle="collapse" data-target="#paidJobBoards" aria-expanded="false" aria-controls="paidJobBoards">advertise this job on more paid job board</a>. If not, just hit the 'Post my job' button below</p><br>
                          <a class="btn btn-line hidify" data-toggle="collapse" data-target="#paidJobBoards" aria-expanded="false" aria-controls="paidJobBoards">Advertise on more job boards</a>
                          <span class="hidify">&nbsp; or &nbsp; </span>
                          <a href="#" data-toggle="modal" data-target="#success" class="btn btn-success"><i class="fa fa-check"></i> &nbsp;Post my Job</a>
                            <hr>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <button type="button" class="close pull-right" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <br>
                  <span class="text-success">Your Job is being posted on the free Job boards! </span>
