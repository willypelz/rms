...
for row in $(echo "${CLIENTS_IN_PRODUCT}" | jq -r '.[] | @base64'); do
    ...
    MOUNT_PATH=${BASE_PATH}/mnt/client
    ...
    ln -sfn ${APP_CLIENT_PATH}/storage ${DEPLOY_PATH}/storage
