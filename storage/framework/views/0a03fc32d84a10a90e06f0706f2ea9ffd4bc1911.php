                ...
                <div class="col-sm-12">
                    <div class="page no-bod-rad">
                        ...
                        <div class="btn-group btn-group-justified btn-tabs job-dash no-pad text-brandon" role="group" aria-label="...">
                          <div class="btn-group" role="group">
                            <a href="<?php echo e(url('jobs/dashboard')); ?>" type="button" class="btn btn-line text-capitalize text-muted in">
                          ...
                          <div class="btn-group" role="group">
                            <a href="<?php echo e(url('jobs/matching')); ?>" type="button" class="btn btn-line text-capitalize text-muted">
