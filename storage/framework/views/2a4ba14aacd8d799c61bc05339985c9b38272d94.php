                ...
                <div class="col-sm-12 ">
                        ...
                        <div class=" btn-group-justified btn-dash" role="group" aria-label="...">
                          <div class="btn-group" role="group">
                            <a href="<?php echo e(url('jobs/create')); ?>" type="button" class="btn btn-success text-capitalize in">
                          ...
                          <div class="btn-group" role="group">
                            <a href="<?php echo e(url('cv/search-results')); ?>" type="button" class="btn btn-line text-capitalize">
                          ...
                          <div class="btn-group" role="group">
                            <a href="<?php echo e(url('jobs/create')); ?>" type="button" class="btn btn-line text-capitalize">
