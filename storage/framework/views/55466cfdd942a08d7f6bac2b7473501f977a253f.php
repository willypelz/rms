    <div class="navbar navbar-fixed-top no-margin fold" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('dashboard')); ?>"><b><i class="fa fa-skype"></i>&nbsp; Seamless Hiring</b></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a class="" href="<?php echo e(url('jobs/list')); ?>">My Jobs <i class="fa fa-briefcase mask"></i></a>
                    </li>


                    <li class="">
                        <a class="" href="<?php echo e(url('jobs/create')); ?>">My Company <i class="fa fa-building mask"></i></a>
                    </li>
