                ...
                <div class="row">
                    ...
                    <div class="col-xs-7">
                        ...
                        <ul class="list-inline text-white">
                            ...
                            <!-- <li>
                                <a href="create-<?php echo e(url('jobs/preview')); ?>" class="btn btn-line btn-sm"><i class="fa fa-eye"></i> View Job</a>
                            </li> -->
                            <!-- <li>
                                <a href="create-<?php echo e(url('jobs/preview')); ?>" class="btn btn-danger btn-sm"><i class="fa fa-pencil"></i> Edit Job</a>
                            </li> -->
                            <li>
                    ...
                    <div class="col-xs-5 job-progress-xs">
                        ...
                        <div class="btn-group btn-group-justified" role="group">
                            ...
                            <div  class="btn-group" role="group">
                                <a href="<?php echo e(url('jobs/preview')); ?>" target="_blank" type="button" class="btn-sm btn btn-success status"><i class="fa fa-file"></i> Preview</a>
                            </div>
                            <div  class="btn-group" role="group">
                                <a href="create-<?php echo e(url('jobs/preview')); ?>" type="button" class="btn-sm btn btn-success status"><i class="fa fa-pencil"></i> Edit Details</a>
                            </div>
                        </div>
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <div class="comment media">
                                            <a class="pull-left" href="#">
                                                <img class="media-object" src="<?php echo e(asset('img/avatar.jpg')); ?>" alt="">
                                            </a>
